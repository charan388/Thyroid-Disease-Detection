...
class dBOperation:
    ...
    def __init__(self):
        ...
        self.badFilePath = "C:/Users/charan/Desktop/Training_Raw_files_validated/Bad_Raw"
        self.goodFilePath = "C:/Users/charan/Desktop/Training_Raw_files_validated/Good_Raw"
        self.logger = App_Logger()
        self.secure_connect_bundle = 'secure-connect-thyroid-data.zip'
        self.client_id = 'LhfveDHkatDqLQTSofoZJAPZ'
        self.client_secret = 'eEQkiAlGZx,yNG1Od5fiG3ZcO4,71xs1noaM4L2e0KM15ngYKNHbCrLJ-d.RFOeS9kCI9K5UpeYGPyxYYaYm_SUkeMDtAu6jTFpYJB5mwT1m0OprjHCLn-zrUzQ_,DC3'
    ...
    def dataBaseConnection(self):
        ...
        try:
            ...
            file = open("CassandraConnectionLog.txt", 'a+')
    ...
    def createTableDb(self):
        ...
        try:
            ...
            try:
                ...
                file = open("CassandraTableLog.txt", 'a+')
    ...
    def insertIntoTableGoodData(self):
        ...
        log_file = open("CassandraInsertionLog.txt", 'a+')
    ...
    def selectingDatafromtableintocsv(self):
        ...
        log_file = open("ExportToCsv.txt", 'a+')
        try:
            session = self.dataBaseConnection()
...
if __name__ == "__main__":
    dbase = dBOperation()
    dbase.selectingDatafromtableintocsv()